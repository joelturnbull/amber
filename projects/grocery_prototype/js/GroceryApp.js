...
fn: function (){
var self=this;
smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_ajax_options_", [smalltalk.send(unescape("http%3A//localhost/couchdb/recipes/"), "__comma", [smalltalk.send(self, "_id", [])]), smalltalk.HashedCollection._fromPairs_([smalltalk.send("type", "__minus_gt", ["PUT"]),smalltalk.send("contentType", "__minus_gt", [unescape("application/json")]),smalltalk.send("data", "__minus_gt", [smalltalk.send(self, "_asJSON", [])]),smalltalk.send("success", "__minus_gt", [(function(jsonp){return smalltalk.send(self, "_update", []);})])])]);
return self;},
args: [],
source: unescape('save%0A%09jQuery%20%0A%09%20%20ajax%3A%20%27http%3A//localhost/couchdb/recipes/%27%2C%20self%20id%0A%09%20%20options%3A%20%23%7B%0A%09%09%09%09%27type%27%20-%3E%20%27PUT%27.%0A%09%09%09%09%27contentType%27%20-%3E%20%27application/json%27.%0A%09%09%09%09%27data%27%20-%3E%20self%20asJSON.%0A%09%09%09%09%27success%27%20-%3E%20%5B%20%3Ajsonp%20%7C%20self%20update%20%5D%0A%09%20%09%20%20%20%20%20%20%20%20%7D.'),
...
smalltalk.addClass('RecipeViewTest', smalltalk.TestCase, [], 'GroceryApp');
smalltalk.addMethod(
...
recipeView=smalltalk.send((smalltalk.RecipeView || RecipeView), "_on_", [recipe]);
element=smalltalk.send(unescape("%3Cdiv%3E"), "_asJQuery", []);
smalltalk.send(recipeView, "_renderOn_", [smalltalk.send((smalltalk.HTMLCanvas || HTMLCanvas), "_onJQuery_", [element])]);
smalltalk.send(self, "_assert_", [smalltalk.send(smalltalk.send(element, "_text", []), "_includesSubString_", [smalltalk.send(recipe, "_name", [])])]);
return self;},
args: [],
source: unescape('testDisplaysName%0A%7C%20recipe%20recipeView%20element%20%7C%0A%0A%09recipe%20%3A%3D%20Recipe%20named%3A%20%27Tacos%27.%0A%09recipeView%20%3A%3D%20RecipeView%20on%3A%20recipe.%0A%09element%20%3A%3D%20%27%3Cdiv%3E%27%20asJQuery.%0A%0A%09recipeView%20renderOn%3A%20%28HTMLCanvas%20onJQuery%3A%20element%29.%0A%09self%20assert%3A%20%28%20element%20text%20includesSubString%3A%20recipe%20name%20%29.'),
messageSends: ["named:", "on:", "asJQuery", "renderOn:", "onJQuery:", "assert:", "includesSubString:", "text", "name"],
referencedClasses: ["Recipe", "RecipeView", "HTMLCanvas"]
}),
