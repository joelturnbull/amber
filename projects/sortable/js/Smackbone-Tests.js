smalltalk.addPackage('Smackbone-Tests', {});
...
fn: function (){
var self=this;
return smalltalk.send((smalltalk.HashedCollection || HashedCollection), "_with_with_with_", [smalltalk.send("", "__minus_gt", ["default"]), smalltalk.send("another one", "__minus_gt", ["anotherOne"]), smalltalk.send(unescape("funky-one"), "__minus_gt", ["funky"])]);
return self;},
args: [],
source: unescape('routes%0A%09%5E%20HashedCollection%20with%3A%20%27%27%20-%3E%20%27default%27%20with%3A%20%27another%20one%27%20-%3E%20%27anotherOne%27%20with%3A%20%27funky-one%27%20-%3E%20%27funky%27'),
...
referencedClasses: [SmackboneHistorian, SmackboneTestSimpleRouter]
}),
...
referencedClasses: [nil, SmackboneTestSimpleRouter]
}),
smalltalk.SmackboneHistorianTest);
...
referencedClasses: [SmackboneTestStringRenderingView, SmackboneHistorian]
}),
smalltalk.SmackboneHistorianTest);
...
referencedClasses: [SmackboneTestFakeWindow]
}),
...
referencedClasses: [SmackboneTestStringRenderingView, SmackboneViewRouter]
}),
